...
export const MOCK_INSIGHTS: InsightItem[] = [
  {
    ...
    summary: 'Capital is quietly rotating out of large caps into select mid-cap tokens with strong developer activity.',
  ...
  },
  {
    ...
    summary: 'A short primer on how perpetual funding rates behave when spot and derivatives markets diverge.',
    category: 'Education',
  ...
  },
  {
    ...
    summary: 'Historical patterns suggest altseason tends to begin only after BTC dominance stabilizes.',
    category: 'Research',

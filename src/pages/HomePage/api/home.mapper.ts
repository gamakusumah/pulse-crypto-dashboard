import type { CategoryDto, GlobalDataDto, MarketCoinDto, TrendingCoinItemDto } from '@/pages/HomePage/api/home.types';
import type {
  GlobalMarketStats,
  MarketCategory,
  MarketCoin,
...
export function mapMarketCoin(dto: MarketCoinDto): MarketCoin {
  return {
    ...
    priceChangePercentage24h: dto.price_change_percentage_24h_in_currency ?? dto.price_change_percentage_24h ?? null,

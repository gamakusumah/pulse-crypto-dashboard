...
import { SparklineChart } from '@/pages/HomePage/components/SparklineChart';
    ...
    () => [
      {
        ...
        accessorKey: 'rank',
        cell: ({ getValue }) => (
          <span className="font-mono text-xs text-muted-foreground">{getValue<number | null>() ?? '—'}</span>
        ),
      },
      {
        id: 'coin',
        ...
        cell: ({ row }) => (
          <div className="flex min-w-0 items-center gap-2.5">
            ...
            <div className="min-w-0">
              ...
              <p className="truncate text-xs uppercase text-muted-foreground">{row.original.symbol}</p>
            </div>
          </div>
        ),
      },
